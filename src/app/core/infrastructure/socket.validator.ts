...
export function validateConversationSupersededPayload(data: ConversationSupersededPayload): ConversationSupersededPayload {
  if (!isObject(data)) throw new Error('ConversationSupersededPayload: expected object');
  if (typeof data['oldConversationId'] !== 'string') throw new Error('ConversationSupersededPayload.oldConversationId: expected string');
  if (typeof data['newConversationId'] !== 'string') throw new Error('ConversationSupersededPayload.newConversationId: expected string');
  return data;
}
